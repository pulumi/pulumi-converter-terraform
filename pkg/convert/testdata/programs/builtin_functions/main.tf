...
# Examples for can
output "funcCan0" {
  value = var.can_try_example
}
output "funcCan1" {
  value = can(var.can_try_example.bar)
}
output "funcCan2" {
  value = can(var.can_try_example.boop)
}
...
output "funcTry1" {
  value = try(var.can_try_example.bar, "fallback")
}
output "funcTry2" {
  value = try(var.can_try_example.boop, "fallback")
}
